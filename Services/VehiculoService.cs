...
namespace Project8.Services
{
    public class VehiculoService
    {
        ...
        public VehiculoService()
        {
            string connectionString = "Server=localhost\\SQLEXPRESS;Database=EcommerceDelUsadoDB;Trusted_Connection=True;TrustServerCertificate=True;";
            _repository = new VehiculoRepository(connectionString);
        }

        // Método asincrónico esperado por el ViewModel
        public async Task<List<Vehiculo>> ObtenerVehiculosAsync()
        {
